...
func DefaultVars() map[string]any {
	return map[string]any{
		...
		"enable-active-region":             false,
		"enable-bracketed-paste":           false,
		"enable-keypad":                    false,
		"enable-meta-key":                  true,
		"expand-tilde":                     false,
		"force-meta-prefix":                false,
...
func DefaultBinds() map[string]map[string]Bind {
	return map[string]map[string]Bind{
		"emacs": map[string]Bind{
			...
			Unescape(`\e\C-g`):   Bind{"abort", false},
			...
			Unescape(`\eOD`):     Bind{"backward-char", false},
			Unescape(`\e[D`):     Bind{"backward-char", false},
			...
			Unescape(`\e\C-h`):   Bind{"backward-kill-word", false},
			Unescape(`\e\C-?`):   Bind{"backward-kill-word", false},
			Unescape(`\e[1;3D`):  Bind{"backward-word", false},
			Unescape(`\e[1;5D`):  Bind{"backward-word", false},
			Unescape(`\eb`):      Bind{"backward-word", false},
			// bash-vi-complete (not bound)
			Unescape(`\e<`):     Bind{"beginning-of-history", false},
			Unescape(`\C-a`):    Bind{"beginning-of-line", false},
			Unescape(`\eOH`):    Bind{"beginning-of-line", false},
			Unescape(`\e[H`):    Bind{"beginning-of-line", false},
			Unescape(`\e[200~`): Bind{"bracketed-paste-begin", false},
			Unescape(`\C-xe`):   Bind{"call-last-kbd-macro", false},
			Unescape(`\ec`):     Bind{"capitalize-word", false},
			Unescape(`\C-]`):    Bind{"character-search", false},
			Unescape(`\e\C-]`):  Bind{"character-search-backward", false},
			Unescape(`\e\C-l`):  Bind{"clear-display", false},
			Unescape(`\C-l`):    Bind{"clear-screen", false},
			Unescape(`\C-i`):    Bind{"complete", false},
			Unescape(`\e\e`):    Bind{"complete", false},
			Unescape(`\e!`):     Bind{"complete-command", false},
			Unescape(`\e/`):     Bind{"complete-filename", false},
			Unescape(`\e@`):     Bind{"complete-hostname", false},
			Unescape(`\e{`):     Bind{"complete-into-braces", false},
			Unescape(`\e~`):     Bind{"complete-username", false},
			Unescape(`\e$`):     Bind{"complete-variable", false},
			...
			Unescape(`\e\\`):     Bind{"delete-horizontal-space", false},
			Unescape(`\e-`):      Bind{"digit-argument", false},
			Unescape(`\e0`):      Bind{"digit-argument", false},
			Unescape(`\e1`):      Bind{"digit-argument", false},
			Unescape(`\e2`):      Bind{"digit-argument", false},
			Unescape(`\e3`):      Bind{"digit-argument", false},
			Unescape(`\e4`):      Bind{"digit-argument", false},
			Unescape(`\e5`):      Bind{"digit-argument", false},
			Unescape(`\e6`):      Bind{"digit-argument", false},
			Unescape(`\e7`):      Bind{"digit-argument", false},
			Unescape(`\e8`):      Bind{"digit-argument", false},
			Unescape(`\e9`):      Bind{"digit-argument", false},
			...
			Unescape(`\eA`):      Bind{"do-lowercase-version", false},
			Unescape(`\eB`):      Bind{"do-lowercase-version", false},
			Unescape(`\eC`):      Bind{"do-lowercase-version", false},
			Unescape(`\eD`):      Bind{"do-lowercase-version", false},
			Unescape(`\eE`):      Bind{"do-lowercase-version", false},
			Unescape(`\eF`):      Bind{"do-lowercase-version", false},
			Unescape(`\eG`):      Bind{"do-lowercase-version", false},
			Unescape(`\eH`):      Bind{"do-lowercase-version", false},
			Unescape(`\eI`):      Bind{"do-lowercase-version", false},
			Unescape(`\eJ`):      Bind{"do-lowercase-version", false},
			Unescape(`\eK`):      Bind{"do-lowercase-version", false},
			Unescape(`\eL`):      Bind{"do-lowercase-version", false},
			Unescape(`\eM`):      Bind{"do-lowercase-version", false},
			Unescape(`\eN`):      Bind{"do-lowercase-version", false},
			Unescape(`\eP`):      Bind{"do-lowercase-version", false},
			Unescape(`\eQ`):      Bind{"do-lowercase-version", false},
			Unescape(`\eR`):      Bind{"do-lowercase-version", false},
			Unescape(`\eS`):      Bind{"do-lowercase-version", false},
			Unescape(`\eT`):      Bind{"do-lowercase-version", false},
			Unescape(`\eU`):      Bind{"do-lowercase-version", false},
			Unescape(`\eV`):      Bind{"do-lowercase-version", false},
			Unescape(`\eW`):      Bind{"do-lowercase-version", false},
			Unescape(`\eX`):      Bind{"do-lowercase-version", false},
			Unescape(`\eY`):      Bind{"do-lowercase-version", false},
			Unescape(`\eZ`):      Bind{"do-lowercase-version", false},
			Unescape(`\el`):      Bind{"downcase-word", false},
			// dump-functions (not bound)
			// dump-macros (not bound)
			// dump-variables (not bound)
			Unescape(`\e\C-i`):   Bind{"dynamic-complete-history", false},
			Unescape(`\C-x\C-e`): Bind{"edit-and-execute-command", false},
			// emacs-editing-mode (not bound)
			Unescape(`\C-x)`):    Bind{"end-kbd-macro", false},
			Unescape(`\e>`):      Bind{"end-of-history", false},
			Unescape(`\C-e`):     Bind{"end-of-line", false},
			Unescape(`\eOF`):     Bind{"end-of-line", false},
			Unescape(`\e[F`):     Bind{"end-of-line", false},
			Unescape(`\C-x\C-x`): Bind{"exchange-point-and-mark", false},
			Unescape(`\ex`):      Bind{"execute-named-command", false},
			// export-completions (not bound)
			// fetch-history (not bound)
			// forward-backward-delete-char (not bound)
			// forward-byte (not bound)
			Unescape(`\C-f`):    Bind{"forward-char", false},
			Unescape(`\eOC`):    Bind{"forward-char", false},
			Unescape(`\e[C`):    Bind{"forward-char", false},
			Unescape(`\C-s`):    Bind{"forward-search-history", false},
			Unescape(`\e[1;3C`): Bind{"forward-word", false},
			Unescape(`\e[1;5C`): Bind{"forward-word", false},
			Unescape(`\ef`):     Bind{"forward-word", false},
			Unescape(`\eg`):     Bind{"glob-complete-word", false},
			...
			Unescape(`\e^`): Bind{"history-expand-line", false},
			...
			Unescape(`\e#`):  Bind{"insert-comment", false},
			Unescape(`\e*`):  Bind{"insert-completions", false},
			Unescape(`\e.`):  Bind{"insert-last-argument", false},
			Unescape(`\e_`):  Bind{"insert-last-argument", false},
			Unescape(`\C-k`): Bind{"kill-line", false},
			// kill-region (not bound)
			// kill-whole-line (not bound)
			Unescape(`\e[3;5~`): Bind{"kill-word", false},
			Unescape(`\ed`):     Bind{"kill-word", false},
			// magic-space (not bound)
			// menu-complete (not bound)
			// menu-complete-backward (not bound)
			Unescape(`\C-n`): Bind{"next-history", false},
			Unescape(`\eOB`): Bind{"next-history", false},
			Unescape(`\e[B`): Bind{"next-history", false},
			// next-screen-line (not bound)
			Unescape(`\en`): Bind{"non-incremental-forward-search-history", false},
			// non-incremental-forward-search-history-again (not bound)
			Unescape(`\ep`): Bind{"non-incremental-reverse-search-history", false},
			...
			Unescape(`\e=`):   Bind{"possible-completions", false},
			Unescape(`\e?`):   Bind{"possible-completions", false},
			...
			Unescape(`\eOA`):  Bind{"previous-history", false},
			Unescape(`\e[A`):  Bind{"previous-history", false},
			...
			Unescape(`\e\C-r`): Bind{"revert-line", false},
			Unescape(`\er`):    Bind{"revert-line", false},
			...
			Unescape(`\240`):   Bind{"self-insert", false},
			Unescape(`\241`):   Bind{"self-insert", false},
			Unescape(`\242`):   Bind{"self-insert", false},
			Unescape(`\243`):   Bind{"self-insert", false},
			Unescape(`\244`):   Bind{"self-insert", false},
			Unescape(`\245`):   Bind{"self-insert", false},
			Unescape(`\246`):   Bind{"self-insert", false},
			Unescape(`\247`):   Bind{"self-insert", false},
			Unescape(`\250`):   Bind{"self-insert", false},
			Unescape(`\251`):   Bind{"self-insert", false},
			Unescape(`\252`):   Bind{"self-insert", false},
			Unescape(`\253`):   Bind{"self-insert", false},
			Unescape(`\254`):   Bind{"self-insert", false},
			Unescape(`\255`):   Bind{"self-insert", false},
			Unescape(`\256`):   Bind{"self-insert", false},
			Unescape(`\257`):   Bind{"self-insert", false},
			Unescape(`\260`):   Bind{"self-insert", false},
			Unescape(`\261`):   Bind{"self-insert", false},
			Unescape(`\262`):   Bind{"self-insert", false},
			Unescape(`\263`):   Bind{"self-insert", false},
			Unescape(`\264`):   Bind{"self-insert", false},
			Unescape(`\265`):   Bind{"self-insert", false},
			Unescape(`\266`):   Bind{"self-insert", false},
			Unescape(`\267`):   Bind{"self-insert", false},
			Unescape(`\270`):   Bind{"self-insert", false},
			Unescape(`\271`):   Bind{"self-insert", false},
			Unescape(`\272`):   Bind{"self-insert", false},
			Unescape(`\273`):   Bind{"self-insert", false},
			Unescape(`\274`):   Bind{"self-insert", false},
			Unescape(`\275`):   Bind{"self-insert", false},
			Unescape(`\276`):   Bind{"self-insert", false},
			Unescape(`\277`):   Bind{"self-insert", false},
			Unescape(`\300`):   Bind{"self-insert", false},
			Unescape(`\301`):   Bind{"self-insert", false},
			Unescape(`\302`):   Bind{"self-insert", false},
			Unescape(`\303`):   Bind{"self-insert", false},
			Unescape(`\304`):   Bind{"self-insert", false},
			Unescape(`\305`):   Bind{"self-insert", false},
			Unescape(`\306`):   Bind{"self-insert", false},
			Unescape(`\307`):   Bind{"self-insert", false},
			Unescape(`\310`):   Bind{"self-insert", false},
			Unescape(`\311`):   Bind{"self-insert", false},
			Unescape(`\312`):   Bind{"self-insert", false},
			Unescape(`\313`):   Bind{"self-insert", false},
			Unescape(`\314`):   Bind{"self-insert", false},
			Unescape(`\315`):   Bind{"self-insert", false},
			Unescape(`\316`):   Bind{"self-insert", false},
			Unescape(`\317`):   Bind{"self-insert", false},
			Unescape(`\320`):   Bind{"self-insert", false},
			Unescape(`\321`):   Bind{"self-insert", false},
			Unescape(`\322`):   Bind{"self-insert", false},
			Unescape(`\323`):   Bind{"self-insert", false},
			Unescape(`\324`):   Bind{"self-insert", false},
			Unescape(`\325`):   Bind{"self-insert", false},
			Unescape(`\326`):   Bind{"self-insert", false},
			Unescape(`\327`):   Bind{"self-insert", false},
			Unescape(`\330`):   Bind{"self-insert", false},
			Unescape(`\331`):   Bind{"self-insert", false},
			Unescape(`\332`):   Bind{"self-insert", false},
			Unescape(`\333`):   Bind{"self-insert", false},
			Unescape(`\334`):   Bind{"self-insert", false},
			Unescape(`\335`):   Bind{"self-insert", false},
			Unescape(`\336`):   Bind{"self-insert", false},
			Unescape(`\337`):   Bind{"self-insert", false},
			Unescape(`\340`):   Bind{"self-insert", false},
			Unescape(`\341`):   Bind{"self-insert", false},
			Unescape(`\342`):   Bind{"self-insert", false},
			Unescape(`\343`):   Bind{"self-insert", false},
			Unescape(`\344`):   Bind{"self-insert", false},
			Unescape(`\345`):   Bind{"self-insert", false},
			Unescape(`\346`):   Bind{"self-insert", false},
			Unescape(`\347`):   Bind{"self-insert", false},
			Unescape(`\350`):   Bind{"self-insert", false},
			Unescape(`\351`):   Bind{"self-insert", false},
			Unescape(`\352`):   Bind{"self-insert", false},
			Unescape(`\353`):   Bind{"self-insert", false},
			Unescape(`\354`):   Bind{"self-insert", false},
			Unescape(`\355`):   Bind{"self-insert", false},
			Unescape(`\356`):   Bind{"self-insert", false},
			Unescape(`\357`):   Bind{"self-insert", false},
			Unescape(`\360`):   Bind{"self-insert", false},
			Unescape(`\361`):   Bind{"self-insert", false},
			Unescape(`\362`):   Bind{"self-insert", false},
			Unescape(`\363`):   Bind{"self-insert", false},
			Unescape(`\364`):   Bind{"self-insert", false},
			Unescape(`\365`):   Bind{"self-insert", false},
			Unescape(`\366`):   Bind{"self-insert", false},
			Unescape(`\367`):   Bind{"self-insert", false},
			Unescape(`\370`):   Bind{"self-insert", false},
			Unescape(`\371`):   Bind{"self-insert", false},
			Unescape(`\372`):   Bind{"self-insert", false},
			Unescape(`\373`):   Bind{"self-insert", false},
			Unescape(`\374`):   Bind{"self-insert", false},
			Unescape(`\375`):   Bind{"self-insert", false},
			Unescape(`\376`):   Bind{"self-insert", false},
			Unescape(`\377`):   Bind{"self-insert", false},
			Unescape(`\C-@`):   Bind{"set-mark", false},
			Unescape(`\e `):    Bind{"set-mark", false},
			// shell-backward-kill-word (not bound)
			Unescape(`\e\C-b`): Bind{"shell-backward-word", false},
			Unescape(`\e\C-e`): Bind{"shell-expand-line", false},
			Unescape(`\e\C-f`): Bind{"shell-forward-word", false},
			Unescape(`\e\C-d`): Bind{"shell-kill-word", false},
			Unescape(`\e\C-t`): Bind{"shell-transpose-words", false},
			// skip-csi-sequence (not bound)
			Unescape(`\C-xs`): Bind{"spell-correct-word", false},
			Unescape(`\C-x(`): Bind{"start-kbd-macro", false},
			// tab-insert (not bound)
			Unescape(`\e&`):  Bind{"tilde-expand", false},
			Unescape(`\C-t`): Bind{"transpose-chars", false},
			Unescape(`\et`):  Bind{"transpose-words", false},
			...
			Unescape(`\eu`):  Bind{"upcase-word", false},
			...
			// Unescape(`\e.`): Bind{"yank-last-arg", false}, // DUPLICATE KEY
			// Unescape(`\e_`): Bind{"yank-last-arg", false}, // DUPLICATE KEY
			Unescape(`\e\C-y`): Bind{"yank-nth-arg", false},
			Unescape(`\ey`):    Bind{"yank-pop", false},
		},
		...
		"emacs-meta": map[string]Bind{
			...
			Unescape(`x`): Bind{"execute-named-command", false},
			// export-completions (not bound)
			// fetch-history (not bound)
			// forward-backward-delete-char (not bound)
			// forward-byte (not bound)
		...
		"emacs-ctlx": map[string]Bind{
			...
			// execute-named-command (not bound)
			// export-completions (not bound)
			// fetch-history (not bound)
			// forward-backward-delete-char (not bound)
			// forward-byte (not bound)
			...
			// skip-csi-sequence (not bound)
			Unescape(`s`): Bind{"spell-correct-word", false},
		...
		"vi": map[string]Bind{
			...
			Unescape(`\e[1;3D`): Bind{"backward-word", false},
			Unescape(`\e[1;5D`): Bind{"backward-word", false},
			Unescape(`*`):       Bind{"bash-vi-complete", false},
			Unescape(`=`):       Bind{"bash-vi-complete", false},
			Unescape(`\\`):      Bind{"bash-vi-complete", false},
			// beginning-of-history (not bound)
			Unescape(`\eOH`): Bind{"beginning-of-line", false},
			...
			Unescape(`d`): Bind{"vi-delete-to", false},
			// vi-eWord (not bound)
			Unescape(`v`): Bind{"vi-edit-and-execute-command", false},
			// vi-editing-mode (not bound)
			// vi-end-bigword (not bound)
			...
			Unescape(`\C-_`): Bind{"vi-undo", false},
			Unescape(`u`):    Bind{"vi-undo", false},
		...
		"vi-insert": map[string]Bind{
			...
			// vi-insertion-mode (not bound)
			// vi-match (not bound)
			Unescape(`\e`): Bind{"vi-movement-mode", false},
			// vi-next-word (not bound)
			// vi-overstrike (not bound)
			// vi-overstrike-delete (not bound)
			// vi-prev-word (not bound)
